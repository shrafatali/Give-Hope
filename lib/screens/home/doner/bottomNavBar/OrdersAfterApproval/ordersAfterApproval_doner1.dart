...
class OrderAfterApprovalDoner1 extends StatefulWidget {
  int index;
  bool isShipped;
  bool isDelivered;
  ...
  @override
  State<OrderAfterApprovalDoner1> createState() =>
      _OrderAfterApprovalDoner1State();
}

class _OrderAfterApprovalDoner1State extends State<OrderAfterApprovalDoner1> {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: getDonerOrders(context, widget.isShipped, widget.isDelivered),
  ...
  Stream<Widget> getDonerOrders(
      context, bool isShipped, bool isDelivered) async* {
    List<Widget> x = [];
